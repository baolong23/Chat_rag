...
resource "aws_api_gateway_method" "root_get" {
  rest_api_id   = aws_api_gateway_rest_api.rag_api.id
  resource_id   = aws_api_gateway_rest_api.rag_api.root_resource_id
  http_method   = "ANY"
  authorization = "NONE"
}
...
resource "aws_api_gateway_deployment" "rag_api_deployment" {
  ...
  depends_on = [
    aws_api_gateway_integration.rag_service_integration,
    aws_api_gateway_integration.root_proxy  # 👈 thêm dòng này
  ]
}
